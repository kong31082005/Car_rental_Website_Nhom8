...
| 2 | **Vũ Trường Giang** | 23810310117 | **Thành viên** | <br>**Phát triển Chức năng & Giao diện (UI) phía Quản trị (Admin):**<br>• **UI Trang chủ Admin (Admin Dashboard):** Thống kê doanh thu, số lượng đơn đặt xe, biểu đồ tổng quan hệ thống.<br>• **UI & Logic Quản lý xe (CRUD Car):** Form thêm xe mới, sửa thông tin, xóa xe và quản lý bộ sưu tập ảnh xe (`CarImage`).<br>• **UI & Logic Quản lý người dùng (User Management):** Danh sách tài khoản, phân quyền Customer/Admin.<br><br>**Phát triển Luồng xử lý nghiệp vụ cốt lõi (Backend & Frontend):**<br>• **UI & Logic Quản lý đơn thuê (Booking Management):** Hệ thống tiếp nhận, xử lý chuyển đổi trạng thái đơn hàng (Chờ duyệt -> Đã duyệt -> Hoàn thành).<br>• **UI & Logic Thanh toán trực tuyến (Payment System):** Tích hợp cổng thanh toán thực tế **PayOS API**; Xử lý tạo cổng QR Code tự động trên UI và cấu hình Webhook đón trạng thái giao dịch để cập nhật đơn hàng thành "Đã thanh toán".<br>• **UI & Dịch vụ Hợp đồng điện tử (Rental Agreement):** Tích hợp dịch vụ kết xuất tài liệu, tự động sinh và hiển thị file Hợp đồng điện tử định dạng PDF trực quan trên giao diện sau khi thanh toán thành công.<br>• **UI Quản lý tài khoản cá nhân (Profile):** Giao diện cập nhật thông tin cá nhân, thay đổi mật khẩu của người dùng. |

---
## 🔗 Thông tin dự án
* **Link Website Online:** [https://car-rentalweb.vercel.app/home]
* **Link Video Demo:** [Xem Video Thuyết Minh Tại Đây][https://youtu.be/9MqF3SnLvXc]
