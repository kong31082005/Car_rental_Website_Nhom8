        ...
        <main className="admin-content">
          ...
          <div className="welcome-card">
            ...
            <div className="welcome-text">
              Chào mừng bạn quay trở lại hệ thống quản trị Kongcars. Tại đây bạn có thể
              quản lý xe, đơn thuê, người dùng, hợp đồng, voucher và các nội dung
              tin tức của nền tảng.
            </div>
          </div>
